;;; tango-now-light-theme.el --- Theme
...
;;
;; (load-theme 'tango-now-light t)
;;

;;; Code:

 (deftheme tango-now-light)
 (let ((class '((class color) (min-colors 89)))
       (fg1 "#2e3436")       ;; Slate
       (fg2 "#3f4446")
       (fg3 "#4f5456")
       (fg4 "#606566")
       (bg1 "#ffefd6")       ;; A lighter version of Orange
       (bg2 "#ebdcc5")
       (bg3 "#d6c9b4")
       (bg4 "#c2b6a3")
       (builtin "#204a87")   ;; Sky Blue Shadow
       (keyword "#4e9a06")   ;; Chameleon Shadow
       (const   "#75507b")   ;; Plum Shadow
       (comment "#4e9a06")   ;; Chameleon Shadow
       (func    "#a40000")   ;; Scarlet Red Shadow
       (str     "#8f5902")   ;; Chocolate Shadow
       (type    "#3465a4")   ;; Sky Blue Shadow
       (var     "#ce5c00")   ;; Orange Shadow
...
(provide-theme 'tango-now-light)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; tango-now-light-theme.el ends here
